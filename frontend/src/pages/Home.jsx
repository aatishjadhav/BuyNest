      ...
      <div className="container">
        ...
        <div className="text-center py-5">
          ...
          <div className="row py-3 rounded">
            <div className="col-md-3 mb-3" style={{cursor: 'pointer'}}  onClick={() => handleCategoryClick("mens")}>
              <div className="bg-light vspace=4" style={{ padding: "6rem 6rem" }}>
            ...
            <div className="col-md-3 mb-3" style={{cursor: 'pointer'}} onClick={() => handleCategoryClick("womens")}>
            ...
            <div className="col-md-3 mb-3" style={{cursor: 'pointer'}} onClick={() => handleCategoryClick("kids")}>
              <div className="bg-light" style={{ padding: "6rem 6rem" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div className="col-md-3 mb-3" style={{cursor: 'pointer'}} onClick={() => handleCategoryClick("electronics")}>
              <div className="bg-light" style={{ padding: "6rem 6rem" }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
